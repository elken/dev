    ...
    [:div.pt-3.flex.flex-row.items-center.justify-around
     (when github
       [:a.transition.ease-in-out.duration-200.hover:-translate-y-1.hover:scale-110.rounded-full.p-2.!text-white
        ...
        (icons/render :phosphor.regular/github-logo {:size "64px"})])
     (when gitlab
       [:a.transition.ease-in-out.duration-200.hover:-translate-y-1.hover:scale-110.rounded-full.p-2.!text-white
        ...
        (icons/render :phosphor.regular/gitlab-logo {:size "64px"})])
     (when linkedin
       [:a.transition.ease-in-out.duration-200.hover:-translate-y-1.hover:scale-110.rounded-full.p-2.!text-white
        ...
        (icons/render :phosphor.regular/linkedin-logo {:size "64px"})])]]))
